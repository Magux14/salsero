...
export const figures = [
  {
    ...
    steps: [
      ...
      'encesto',
      'exhibo',
      'corono con mano derecha (mano izquierda enfrente y abajo)',
      'vuelta hacía afuera con mano izquierda (meno derecha sigue mismo lugar)',
      'mano izquierda cae sombre bicep derecho',
      'mano derecha sube para terminar vuelta y pasa por arriba de la cabeza',
      'mano derecha suelta',
      'dile que no'
    ]
  },
  {
    ...
    steps: [
      ...
      'atrapas con mano derecha',
      'le das vuelta hacia afuera',
      'le das otra vuelta para terminar abrazándola como novia',
      'le extiendes la mano izquierda para que te agarre',
      'con las 2 manos vuelta a la izquierda',
      'sombrero'
    ]
  },
  {
    ...
    steps: [
      ...
      'mano derecha YO me doy vuelta entrando',
      'agarro mano izquierda de nuevo',
      'enchuflo mano izquierda mientras suelto mano derecha',
      'encesto'
    ]
  },
  {
    ...
    steps: [
      ...
      'caminando por atrás de ella hacia la derecha mi mano izquierda tiene que estar en su cuello',
      'mano derecha hacia arriba dandole vuelta hacia adentro',
      'mani izquierda pasa por abajo de la derecha (la sigues agarrando ambas manos)',
      'una vez que ya dió la vuelta subes mano izquierda',
      'randem',
  ...
  },
  {
    ...
    steps: [
      ...
      'quito codo derecho',
      'mano derecha se queda abajo',
      'llevala al rodeo con mano izquierda, tu mano izquierda reposará sobre tu hombro derecho',
      'una vez que cruze el rodeo, levantas mano derecha para que quede a tu derecha',
      'sueltas mano derecha',
      'la peinas con mano izquierda',
    ]
  },
  {
    id: 6,
    ...
    steps: [
      ...
      'ambas manos, vuelta con mano izquierda arriba hacia AFUERA, mano derecha abajo',
      'enchuflo ambas manos',
      'codazo mano izquierda que repose en su brazo derecho',
      'codazo mano derecha que repose en su brazo izquierdo',
      'vuelta abrazaditos',
      'quito codoa',
      'mano derecha se queda abajo',
      'llevala al rodeo con mano izquierda, tu mano izquierda reposará sobre tu hombro derecho',
  ...
  },
  {
    ...
    steps: [
      ...
      'vuelta hacía afuera con mano izquierda (meno derecha sigue mismo lugar)',
      'mano izquierda cae sombre bicep derecho',
      'mano derecha sube para llevarla al rodeo',
      'cuando ella llegue a la izquierda mi codo izquierdo reposa en su brazo derecho',
      'la sigues girando mientras quitas el codo izquierdo',
      'la sigues girando y tu codo derecho reposa en su brazao izquierdo',
      'quitas codo derecho',
      'vuelta con la mano izquierda'
    ]
  },
  {
    id: 8,
    ...
    steps: [
      ...
      'rodeo',
      'manita de puerco, bajas y cruzas su brazo derecho',
      'vuelta con las 2 manos hacia adentro',
      'enchufla con 2 manos',
      'sombrero',
    ]
  },
  {
    ...
    steps: [
      ...
      'rodeo con ambas manos',
      'terminas posición de fusión con brazos a la izquierda',
      'con ambas manos vuelta a la derecha (nunca se sueltan)',
      'sombrero',
    ]
  },
  {
    ...
    steps: [
      'cambio mano',
      'con ambas manos vuelta a la derecha (nunca se sueltan)',
      'marcha de su izquierda hasta que llegues a la derecha',
      'enchufla con las 2 manos',
      'randem (mano izquierda termina atrás, derecha en medio)',
      'ella está atrás',
      'con la mano derecha la llevas para atrás para que gire',
  ...
  },
  {
    ...
    steps: [
      ...
      'enchuflo ambas manos',
      'encesta',
      'exhibo y rodeo  a posición de 82 (dejo mi mano izquierda abajo atrás)',
  ...
  },
  {
    ...
    steps: [
      'enchuflas',
      'encentas',
      'coronas brazo derecho',
      'exhibes con brazo izquierdo',
      'te la llevas a rodeo con brazo derecho',
      'cuando la chica llegue a tu izquierda poner tu codo izquierdo en su antebrazo izquierdo mientras sigue de rodeo',
      'cuando llegue a tu derecha pones codo derecho en su antebrazo derecho y aquí deja de rodear la chica',
      'tu brazo izquierdo lo tienes pegado a tu costado y con tu mano derecha le das vuelta a la chica a su izquierda mientras la pasas a tu izquierda',
      'tu mano izquierda quedará en su espalda y tu mano derecha arriba de tu cabeza',
      'pasas por abajo de su brazo izquierdo como en un 90 caminando hacia la izquierda',
      'tu mano izquierda quedará en tu espalda y tu mano derecha a la altura de la cabeza de la chica',
      'la enchuflas con tu mano derecha para quedar frente a ella',
      'metes randem tipo kentucky',
      'dile que no'
    ]
  },
  {
    ...
    steps: [
      ...
      'Hombres:',
      'lateral izquierdo',
      'recorres pie derecho a la izquierda',
      'cruzas pie izquierdo',
      'pie derecho sigue para terminar con pie derecho un poco abierto',
      'giras 45° a la izquierda',
      'haces un "basilala" (vuelta a la izquierda)',
      'al terminar el basilala caminar con tu pie derecho a la derecha',
      'tu pie izquierdo cruza hacia atrás',
      'pie derecho marca base',
      'pie izquierdo se va hacía enfrente y a la izquierda (para darle espacio a la chava)',
      'pie derecho cruza para atrás mientras das 2 aplausos',
      'dile que no',
      'Mujeres:',
      'pie derecho atrás',
      'pie izquierdo base',
      'te exhibes solita (con adorno si se puede)',
      'pie derecho atrás',
      'pie izquierdo base',
      'das un paso con tu pie derecho a modo que gires 45% la izquierda',
      'pie ziquierdo base (acercandose un poco al pie derecho)',
      'pie izquierdo camina luego derecho mientras giras 180% y moviéndote hacia la izquierda',
      'tu pie izquierdo cruza hacia atrás',
      'tu pie derecho cruza hacia atrás',
      'dile que no',
    ]
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      'manteniendo el saludo de macho vas a rotar con ella hasta que vuelvas a llegar a la derecha',
      'ahora con tu mano izquierda vas a agarrar su omóplato izquierdo para mandarla a la derecha como un paseo largo mientras igual la jalas con tu mano derecha',
